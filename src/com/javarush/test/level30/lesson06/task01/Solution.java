...
/*        if(d.cs.get(0).bs.get(0).as.get(0).flag){
        ...
        if(d.cs != null && d.cs.size() != 0 && d.cs.get(0).bs != null && d.cs.get(0).bs.size() != 0 && d.cs.get(0).bs.get(0).as != null && d.cs.get(0).bs.get(0).as.size() != 0 && d.cs.get(0).bs.get(0).as.get(0).flag){
            System.out.println("A's flag is true");
        } else { //all other cases
            System.out.println("Oops!");
        }
