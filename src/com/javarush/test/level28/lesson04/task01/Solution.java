...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory{
        ...
        private static AtomicInteger totalFactories = new AtomicInteger(0);
        private List<Thread> threadList = new ArrayList<>();

        public AmigoThreadFactory()
        {
            factoryNumber = new AtomicInteger(totalFactories.incrementAndGet());
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            String threadName = thread.getThreadGroup().getName() + "-pool-" + factoryNumber + "-thread-" + new AtomicInteger(threadList.size());
